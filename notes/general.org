...
2) Install the necessary files/programs
   - Install emacs and git #+BEGIN_SRC sudo apt install emacs git#+END_SRC
   ...
   - iconsolata font #+BEGIN_SRCsudo apt install fonts-inconsolata#+END_SRC
   - emacs-goodies package #+BEGIN_SRCsudo apt install emacs-goodies-el#+END_SRC
